  ...
  return (
    <div className=" container mx-auto px-4 py-16 ">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10">
        <div className="card hover:scale-105 transition-transform duration-300 w-full bg-base-100 shadow-sm">
          <div className="card-body">
            ...
            <div className="mt-6">
              ...
              font-semibold btn-block rounded-full"
              >
                Get Started Free
              </button>
            </div>
        ...
        <div className="card hover:scale-105 transition-transform duration-300 w-full bg-gradient-to-r  from-[#4F39F6] to-[#9514FA] text-white shadow-sm relative">
          <div className="card-body">
            ...
            <div className="mt-6">
              <button
                className="btn bg-white text-[#4F39F6]
              font-semibold btn-block rounded-full"
              >
                Get Started Free
              </button>
